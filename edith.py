...
def wishMe():
    speak("Turning on Powers Server Online")
    speak("Welcome back!")
    ...
    if hour>=6 and hour<12:
        speak("Good Morning! Shoaib")

    elif hour>=12 and hour<18:
        speak("Good Afternoon!Shoaib")

    elif hour>=18 and hour<24:
        speak("Good Evening! Shaoib")

    else:
        speak("Good Night! Shoaib")
...
if __name__ == "__main__":
    ...
    #    #time
            ...
            quit()
             ...
             os.system('cmd /k "start chrome https://www.instagram.com/ft.shoaiib"')
        elif "who i am" in query:
            speak(" Your are my Chief Shoaib Sir  i'm glad to be your assistant")
